...
//#define MATCH_BNDI 0x4067
//#define MASK_BNDI  0x707f
#define MATCH_BNDR 0x1067
#define MASK_BNDR  0xfe00707f
#define MATCH_LBDU 0x5067
#define MASK_LBDU  0x707f
#define MATCH_LBDL 0x6067
#define MASK_LBDL  0x707f
#define MATCH_LBDUS 0x7067
#define MASK_LBDUS  0x707f
#define MATCH_LBDLS 0x4067
#define MASK_LBDLS  0x707f
#define MATCH_SBDU 0x2067
#define MASK_SBDU  0x707f
#define MATCH_SBDL 0x3067
#define MASK_SBDL  0x707f
#define MATCH_LB_B 0xb
#define MASK_LB_B  0x707f
#define MATCH_LH_B 0x100b
#define MASK_LH_B  0x707f
#define MATCH_LW_B 0x200b
#define MASK_LW_B  0x707f
#define MATCH_LD_B 0x300b
#define MASK_LD_B  0x707f
#define MATCH_LBU_B 0x400b
#define MASK_LBU_B  0x707f
#define MATCH_LHU_B 0x500b
#define MASK_LHU_B  0x707f
#define MATCH_LWU_B 0x600b
#define MASK_LWU_B  0x707f
#define MATCH_SB_B 0x402b
#define MASK_SB_B  0x707f
#define MATCH_SH_B 0x502b
#define MASK_SH_B  0x707f
#define MATCH_SW_B 0x602b
#define MASK_SW_B  0x707f
#define MATCH_SD_B 0x702b
#define MASK_SD_B  0x707f
...
#define CSR_MBOUNDS 0x7c0
#define CSR_SBOUNDS 0x5c0
#define CSR_UBOUNDS 0x800
...
#define CAUSE_OUT_OF_BOUNDS 0x10
#endif
#ifdef DECLARE_INSN
//DECLARE_INSN(bndi, MATCH_BNDI, MASK_BNDI)
DECLARE_INSN(bndr, MATCH_BNDR, MASK_BNDR)
DECLARE_INSN(lbdu, MATCH_LBDU, MASK_LBDU)
DECLARE_INSN(lbdl, MATCH_LBDL, MASK_LBDL)
DECLARE_INSN(lbdus, MATCH_LBDUS, MASK_LBDUS)
DECLARE_INSN(lbdls, MATCH_LBDLS, MASK_LBDLS)
DECLARE_INSN(sbdu, MATCH_SBDU, MASK_SBDU)
DECLARE_INSN(sbdl, MATCH_SBDL, MASK_SBDL)
DECLARE_INSN(lb_b, MATCH_LB_B, MASK_LB_B)
DECLARE_INSN(lh_b, MATCH_LH_B, MASK_LH_B)
DECLARE_INSN(lw_b, MATCH_LW_B, MASK_LW_B)
DECLARE_INSN(ld_b, MATCH_LD_B, MASK_LD_B)
DECLARE_INSN(lbu_b, MATCH_LBU_B, MASK_LBU_B)
DECLARE_INSN(lhu_b, MATCH_LHU_B, MASK_LHU_B)
DECLARE_INSN(lwu_b, MATCH_LWU_B, MASK_LWU_B)
DECLARE_INSN(sb_b, MATCH_SB_B, MASK_SB_B)
DECLARE_INSN(sh_b, MATCH_SH_B, MASK_SH_B)
DECLARE_INSN(sw_b, MATCH_SW_B, MASK_SW_B)
DECLARE_INSN(sd_b, MATCH_SD_B, MASK_SD_B)
...
DECLARE_CSR(ubounds, CSR_UBOUNDS)
DECLARE_CSR(mbounds, CSR_MBOUNDS)
DECLARE_CSR(sbounds, CSR_SBOUNDS)
#endif
#ifdef DECLARE_CAUSE
...
DECLARE_CAUSE("out of bounds", CAUSE_OUT_OF_BOUNDS)
#endif
